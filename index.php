...
<head>
  ...
  <link rel="stylesheet" href="asset/css/awesome-font/css/font-awesome.min.css" type="text/css"/>
</head>
<body>
...
<div class="container">
 <div class="sidebar">
  ...
  <a class="logo-expand" href="#">Webcast</a>
 ...
 <div class="wrapper">
  ...
  <div class="main-container">
   ...
   <?php
      ...
      $callNewPostController -> _fetchPost1();
    ?>
   </div>
   <div class="stream-area">
    ...
    <div class="chat-stream">
     <div class="chat">
      ...
      <div class="message-container" id="messageDivId" postId="1">
        <?php
          $db = new Database();
          $postCount=0;
      ...
      <div class="chat-footer anim" style="--delay: .1s">
        <div class="chat-footerContent">
          <i class="fa fa-ellipsis-h"></i>
          <input type="text" placeholder="Write your message" id="chat_content_id">
          <i  onclick="_send_chat()" class="fa fa-send"></i>
        </div>
      </div>
     </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/4.5.4/socket.io.js"></script>  
    <script>
        function _send_chat(){
         ...
         var chat_content = jQuery('#chat_content_id').val();
         var node = $("<div class='message anim' style='--delay: .3s'> <div class='author-img__wrapper video-author video-p'> <svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='3' stroke-linecap='round' stroke-linejoin="round" class='feather feather-check'><path d='M20 6L9 17l-5-5' /> </svg><img class='author-img' src='asset/img/1.jpg' /></div><div class='msg-wrapper'> <div class='msg__name video-p-name offline'>Johny Wise</div> <div class='msg__content video-p-sub'> '"+chat_content+"' </div> </div> </div>");
            document.getElementById("messageDivId").appendChild(node);
    //       socket.on('roomJoined',function(node){
    //         socket.emit("roomJoined",document.getElementById("messageDivId").appendChild(node));
    // })
     if (chat_content==''){
         //do nothing
     }
     else{
     var dataString = 'chatText='+chat_content+'&postId='+postId;
     $.ajax({
            type: "POST",
